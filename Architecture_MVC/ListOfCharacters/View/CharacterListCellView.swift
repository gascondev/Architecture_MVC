...
class CharacterListCellView: UITableViewCell {
    ...
    // Crear método para añadir subvistas a la vista general
    func setupViews() {
        addSubview(characterImageView) //Subvista
        addSubview(characterName) //Subvista
        addSubview(characterStatus) //Subvista
        addSubview(characterSpecie) //Subvista
